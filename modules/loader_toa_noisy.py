...
class locDL(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for m in range(self.numTx):
            ...
            image_toatrue_noise = image_toaest[RXr,RXc]
            imgToAtrue_Noise = image_toatrue_noise*np.ones(np.shape(image_toaest))
            inputEstMaps.append(imgToAtrue_Noise) 
